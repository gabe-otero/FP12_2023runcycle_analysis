...
processedpolfolder = '/processed_data/'+uniquefolder+'pol_U/'
# processedasymfolder = '/processed_data/'+uniquefolder+'asym_U/'
# processedasymfolder_bg = '/processed_data/'+uniquefolder+'asym_bg_U/'
polSavename = os.getcwd()+processedpolfolder+run_num+'_pol_U'
# AsymSavename = os.getcwd()+processedasymfolder+run_num+'_asym_U'
# AsymSavename_bg = os.getcwd()+processedasymfolder_bg+run_num+'_asym_bg_U'
logger.add("F:/LANL/processed_data/" + uniquefolder + '0_ErrorLog_'+run_start+'_'+run_end+'pol_U.txt', delay = False)
