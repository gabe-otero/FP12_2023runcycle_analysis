...
AsymSavename = os.getcwd()+processedasymfolder+run_num+'_raw_U'  ## CHAT raw-asym output filename
# AsymSavename_bg = os.getcwd()+processedasymfolder_bg+run_num+'_asym_bg_U' ## maybe canget rid of this
logger.add(basedir+"/processed_data/" + uniquefolder + '0_ErrorLog_'+run_start+'_'+run_end+'_raw_U.txt', delay = False)  ## CHAT raw-asym log
