...
processedasymfolder = '/processed_data/'+uniquefolder+'asym_swave_D/'
AsymSavename = os.getcwd()+processedasymfolder+run_num+'_swave_D'
logger.add(basedir+"/processed_data/" + uniquefolder + '0_ErrorLog_'+run_start+'_'+run_end+'_swave_D.txt', delay = False)
