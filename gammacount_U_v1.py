...
# statefileloc = 'F:\LANL\SF_Norm_files\TR_R_expected_avgs_stds_afterclip.csv'
processederrorfolder = '/processed_data/'+uniquefolder+'error_U/'
errorSavename = processederrorfolder+run_num+'_error_U'
logger.add("F:/LANL/processed_data/" + uniquefolder + '1_ErrorLog_'+run_start+'_'+run_end+'_gcount_U.txt', delay = False)
